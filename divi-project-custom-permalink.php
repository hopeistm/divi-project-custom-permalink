<?php
/*
Plugin Name: Divi Project Custom Permalink
Plugin URI:  http://blog.garethjmsaunders.co.uk/2015/03/07/changing-the-divi-projects-custom-post-type-to-anything-you-want/
Description: Change the Divi project custom post type to Speakers in adminui and permalink structure to /speaker. Updated for Divi 2.5+.
Version:     1.1
Author:      Gareth J M Saunders
Author URI:  http://www.garethjmsaunders.co.uk
License:     GPL3
License URI: https://www.gnu.org/licenses/gpl-3.0.html
Text Domain: divi-project-custom-permalink
*/

function child_et_pb_register_posttypes() { $labels = array( 'add_new' => __( 'Add New', 'Divi' ),
                                                            'add_new_item'       => __( 'Add New Speaker', 'Divi' ),
                                                            'all_items'          => __( 'All Speakers', 'Divi' ),
                                                            'edit_item'          => __( 'Edit Speaker', 'Divi' ),
                                                            'menu_name'          => __( 'Speakers', 'Divi' ),
                                                            'name'               => __( 'Speakers', 'Divi' ),
                                                            'new_item'           => __( 'New Speaker', 'Divi' ),
                                                            'not_found'          => __( 'Nothing found', 'Divi' ),
                                                            'not_found_in_trash' => __( 'Nothing found in Trash', 'Divi' ),
                                                            'parent_item_colon'  => '',
                                                            'search_items'       => __( 'Search Speakers', 'Divi' ),
                                                            'singular_name'      => __( 'Speaker', 'Divi' ),
                                                            'view_item'          => __( 'View Speaker', 'Divi' ),
                                                           );
                                           ...
                                           $labels = array(
                                             'name'              => _x( 'Categories', 'Speaker category name', 'Divi' ),
                                             'singular_name'     => _x( 'Category', 'Speaker category singular name', 'Divi' ),
                                           ...
                                           $labels = array(
                                             'name'              => _x( 'Tags', 'Speaker Tag name', 'Divi' ),
                                             'singular_name'     => _x( 'Tag', 'Speaker tag singular name', 'Divi' ),
